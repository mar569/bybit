...
WEDGE_MIN_SWINGS = 4
# Чашка с ручкой + округлое дно/вершина (BuyHold)
CUP_ENABLED = True
CUP_MIN_BARS = 16
CUP_HANDLE_MAX_BARS = 16
CUP_RIM_TOLERANCE_PCT = 4.0
ROUNDED_MIN_BARS = 14
ROUNDED_RIM_TOLERANCE_PCT = 4.5
# Forming-фигуры в foresight/WATCH (ниже порога ENTRY)
MIN_FORMING_REPORT_CONFIDENCE = 0.55
HTF_PATTERN_MIN_CONFIDENCE = 0.62
...
MAX_REPORT_PATTERNS = 3            # LTF: primary + forming/secondary
...
PATTERN_LABELS_RU: dict[str, str] = {
    ...
    "rounded_bottom": "Округлое дно (блюдце)",
    "rounded_top": "Округлая вершина",
