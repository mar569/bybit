...
3) Потом foresight 1–3ч: наиболее вероятный путь цены (не «список индикаторов»).
...
2) КУДА ЖДЁМ: 2–3 строки живым языком — путь цены и ПОЧЕМУ (структура + 1–2 главных подтверждения).
3) ЧТО ДЕЛАТЬ: вход (лимит на откате / триггер), стоп, TP1≥1–2%, TP2, R:R≥1:2.
4) Контекст: коротко что подтверждает / что мешает.
