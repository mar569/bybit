...
class TelegramBot:
    ...
    def _build_settings_panel_text(self) -> str:
        ...
        return (
            ...
            f"(только TELEGRAM_ANOMALY_CHAT_ID · топ <b>{s.anomaly_max_per_minute}</b>/мин · "
            f"важн.≥<b>{s.anomaly_min_importance:.0f}</b>)\n"
            ...
            f"(мейджор ≥<b>${s.analysis_major_min_liq_usd:,.0f}</b> · топ ≥<b>${s.analysis_min_liq_usd:,.0f}</b> · "
